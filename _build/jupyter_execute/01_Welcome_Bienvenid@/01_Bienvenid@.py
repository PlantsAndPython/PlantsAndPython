...
# 
# La programación en biología vegetal puede resultar intimidante para quienes no tienen experiencia previa. Estos materiales están diseñados para hacer que estas disciplinas no se sientan pesadas. **Una diversidad de perspectivas es vital para combatir los mayores desafíos de 
# nuestro tiempo y no hay lugar para guardarse ideas o avergonzarse. Tus contribuciones a la comunidad de ciencias computacionales en plantas son necesarias y valiosas.** 
# 
...
# problema no resuelto? ¿Qué conceptos matemáticos quedan por ser explorados? ¿Cuál es el gran desafío? Siempre puedes 
# llevar este material al siguiente nivel, si ya dominas lo que se está presentando. Investiga más y amplía los límites del conocimiento. De nuevo, sobre todo encuentra alegría en la forma en que las matemáticas y el modelado revelan la belleza subyacente de las plantas.
# 
